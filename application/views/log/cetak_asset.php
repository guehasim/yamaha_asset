            ...
            <table class="table table-striped table-bordered" cellpadding="2" cellspacing="0" style="">
                <thead>
                    <tr style="background:#dadade;">
                        ...
                        <th style="padding: 5px; border: 1px solid black;">Tanggal</th>
                        <th style="padding: 5px; border: 1px solid black;">Repair</th>
                        <th style="padding: 5px; border: 1px solid black;">Assets</th>
                        <th style="padding: 5px; border: 1px solid black;">Lokasi</th>
                        <th style="padding: 5px; border: 1px solid black;">Penanggung Jawab</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><?php echo date('d M y',strtotime($ad->TglRepair));?></td>
                        <td style="text-align:center;"><?php echo $ad->NamaRepair;?></td>
                        <td style="text-align:center;"><?php echo $ad->NamaAsset;?></td>
                        <td style="text-align:center;"><?php echo $ad->NamaLokasi;?></td>
