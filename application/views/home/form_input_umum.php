...
<head>
  ...
  <meta charset="utf-8">
    ...
    <script type="text/javascript">
        function loadAsset()
        {
            var tiket = $("#lokasi_pilih").val();
            $.ajax({
                type:'GET',
                url:"<?php echo base_url(); ?>home/pilih_asset",
                data:"id=" + tiket,
                success: function(html)
                { 
                   $("#tampil_asset").html(html);
                }
            }); 
        }
      ...
      <div class="container">
        <div class="row mt-20">         
          ...
          <div class="col-lg-8 col-xs-12">
            <div class="card">
              <div class="card-body">
                <h2 class="bg-purple-ym p-2 text-center font-weight-bold">Create Repair Report</h2>

                <div>
                  <?php echo $this->session->flashdata('msg'); ?>
                </div> 
                  
                <form data-parsley-validate method="POST" action="<?php base_url();?>Asset/simpanDetail">

                  <input type="text" name="jenis_form" value="1" hidden>

                  <div class="form-group">
                    <label for="" class="mb-1 font-weight-bold font-size-16">Tanggal<span class="required">*</span></label>
                  ...
                  <div class="form-group">
                    <label for="" class="mb-1 font-weight-bold font-size-16">Penanggung Jawab<span class="required">*</span></label>
                  ...
                  <div class="form-group">
                    <label for="" class="mb-1 font-weight-bold font-size-16">Departemen</label>
                    <div id="tampil_dept"><input type="text" class="form-control font-size-16" disabled></div>
                  </div>
                  
                  <div class="form-group">
                    <label for="" class="mb-1 font-weight-bold font-size-16">Lokasi<span class="required">*</span></label>
                    <select class="form-control font-size-16" name="lokasi" id="lokasi_pilih" onclick="loadAsset()" required>
                      <option value=""></option>
                  ...
                  <div class="form-group">
                    <label for="" class="mb-1 font-weight-bold font-size-16">Assets<span class="required">*</span></label>
                    <div id="tampil_asset">
                    <select class="form-control font-size-16" name="id_asset" required>
                      <option value=""></option>
                  </select>
                  </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="" class="mb-1 font-weight-bold font-size-16">Repair<span class="required">*</span></label>
                    <textarea class="form-control font-size-16" name="namarepair" required></textarea>
                  </div>

                  <input type="text" name="id_user_input" value="-" hidden>
                  <br> 
                  <div class="form-group text-right">
                    <button type="submit" class="btn bg-purple-ym">Create</button>
